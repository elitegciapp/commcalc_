...
export default function Splash() {
  return (
    <div className="min-h-screen bg-transparent text-foreground flex flex-col items-center justify-center font-sans selection:bg-primary/20 px-4 relative overflow-hidden">
